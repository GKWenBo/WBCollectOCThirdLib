...
@implementation UIImage (DWQExtension)
...
{
    return [self dwq_resizedImageWithImage:[UIImage imageNamed:name]];
}
 ...
 *  @return 切割好的图片
 */
+ (UIImage *)dwq_cutImage:(UIImage*)image andSize:(CGSize)newImageSize
{
...
{
    return [self dwq_captureCircleImageWithImage:[UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:iconUrl]]] andBorderWith:border andBorderColor:color];
}
...
{
    return [image dwq_blurredImage:blurAmount];
}
