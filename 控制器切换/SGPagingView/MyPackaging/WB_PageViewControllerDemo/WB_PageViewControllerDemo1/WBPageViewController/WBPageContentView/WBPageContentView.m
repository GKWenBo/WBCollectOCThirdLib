...
#import "WBPageContentViewCell.h"
static NSString *kPageCellIdentifier = @"WBPageContentViewCell";
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    WBPageContentViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kPageCellIdentifier forIndexPath:indexPath];
...
/**  < 给外界提供的方法，获取 WB_PageContentView 选中按钮的下标 >  */
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[WBPageContentViewCell class] forCellWithReuseIdentifier:kPageCellIdentifier];
    }
