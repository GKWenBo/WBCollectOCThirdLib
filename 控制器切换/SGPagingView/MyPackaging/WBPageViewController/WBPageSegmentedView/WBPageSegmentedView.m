...
- (void)addTitleButtons {
    [self.titleArr enumerateObjectsUsingBlock:^(NSString *obj, NSUInteger idx, BOOL * _Nonnull stop) {
        CGFloat tempWidth = [self wb_calculateStringWidthWithString:obj font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]];
    ...
    if (self.allBtnWidth <= self.width) {
        ...
        [self.titleArr enumerateObjectsUsingBlock:^(NSString *obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            button.titleLabel.font = [UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont];
        ...
        [self.titleArr enumerateObjectsUsingBlock:^(NSString *obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            btn_w = [self wb_calculateStringWidthWithString:obj font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]] + WB_PageSegmentedViewMargin;
            button.frame = CGRectMake(btn_x, btn_y, btn_w, btn_h);
            btn_x += btn_w;
            button.tag = idx + BTN_TAG;
            button.titleLabel.font = [UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont];
        ...
        [UIView animateWithDuration:self.indicatorAnimationTime animations:^{
            switch (self.indicatorLengthStyle) {
                case WBIndicatorLengthEqualStyle:
                    self.indicatorView.width = [self wb_calculateStringWidthWithString:button.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]];
                    break;
                case WBIndicatorLengthDefaultStyle:
                    self.indicatorView.width = button.width;
                    break;
                case WBIndicatorLengthSpecialStyle:
                    self.indicatorView.width = [self wb_calculateStringWidthWithString:button.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]] + WB_IndicatorTypeSpecialMultipleLength;
                    break;
                default:
                    break;
            }
        ...
        case WBIndicatorScrollHalfStyle:
        {
            if (progress >= 0.5) {
                [UIView animateWithDuration:self.indicatorAnimationTime animations:^{
                    switch (self.indicatorLengthStyle) {
                        case WBIndicatorLengthEqualStyle:
                            self.indicatorView.width = [self wb_calculateStringWidthWithString:targetBtn.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]];
                            break;
                        case WBIndicatorLengthSpecialStyle:
                            self.indicatorView.width = [self wb_calculateStringWidthWithString:targetBtn.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]] + WB_IndicatorTypeSpecialMultipleLength;
                            break;
                        default:
                ...
                [UIView animateWithDuration:self.indicatorAnimationTime animations:^{
                    switch (self.indicatorLengthStyle) {
                        case WBIndicatorLengthEqualStyle:
                            self.indicatorView.width = [self wb_calculateStringWidthWithString:originalBtn.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]];
                            break;
                        case WBIndicatorLengthSpecialStyle:
                            self.indicatorView.width = [self wb_calculateStringWidthWithString:originalBtn.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]] + WB_IndicatorTypeSpecialMultipleLength;
                            break;
                        default:
...
- (void)smallIndicatorScrollStyleDefaultWithProgress:(CGFloat)progress originalBtn:(UIButton *)originalBtn targetBtn:(UIButton *)targetBtn {
    ...
    switch (self.indicatorLengthStyle) {
        case WBIndicatorLengthEqualStyle:
        {
            ...
            /// 计算 targetBtn／originalBtn 宽度的差值
            CGFloat targetBtnDistance = (CGRectGetMaxX(targetBtn.frame) - 0.5 * (self.width / self.titleArr.count - [self wb_calculateStringWidthWithString:targetBtn.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]]));
            CGFloat originalBtnDistance = (CGRectGetMaxX(originalBtn.frame) - 0.5 * (self.width / self.titleArr.count - [self wb_calculateStringWidthWithString:originalBtn.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]]));
            ...
            self.indicatorView.width = [self wb_calculateStringWidthWithString:originalBtn.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]] + distance;
        }
            break;
        case WBIndicatorLengthSpecialStyle:
        {
            CGFloat targetBtnX = CGRectGetMaxX(targetBtn.frame) - [self wb_calculateStringWidthWithString:targetBtn.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]] - 0.5 * (self.width / self.titleArr.count - [self wb_calculateStringWidthWithString:targetBtn.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]] + WB_IndicatorTypeSpecialMultipleLength);
            CGFloat originalBtnX = CGRectGetMaxX(originalBtn.frame) - [self wb_calculateStringWidthWithString:originalBtn.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]] - 0.5 * (self.width / self.titleArr.count - [self wb_calculateStringWidthWithString:originalBtn.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]] + WB_IndicatorTypeSpecialMultipleLength);
            CGFloat totalOffsetX = targetBtnX - originalBtnX;
            ...
            /// 计算 indicatorView 新的 frame
            self.indicatorView.left = originalBtnX + offsetX;
            self.indicatorView.width = [self wb_calculateStringWidthWithString:originalBtn.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]] + distance + WB_IndicatorTypeSpecialMultipleLength;
        }
            break;
        default:
        {
...
- (void)setIndicatorLengthStyle:(WBIndicatorLengthStyle)indicatorLengthStyle {
    ...
    switch (indicatorLengthStyle) {
        case WBIndicatorLengthEqualStyle:
        {
            CGFloat firstBtnTextWidth = [self wb_calculateStringWidthWithString:firstButton.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]];
            W = firstBtnTextWidth;
        ...
        case WBIndicatorLengthSpecialStyle:
        {
            CGFloat firstBtnIndicatorWidth = [self wb_calculateStringWidthWithString:firstButton.currentTitle font:[UIFont systemFontOfSize:WB_PageSegmentedViewTitleFont]] + WB_IndicatorTypeSpecialMultipleLength;
